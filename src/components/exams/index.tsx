...
import { ClipboardCheck, Plus, Calendar, Clock, Users, FileText, ChevronRight, Filter } from "lucide-react";
import { useState } from "react";

const mockExams = [
  { id: 1, title: "Kiểm tra giữa kỳ - Lớp A1", class: "Lớp A1", date: "15/01/2025", time: "09:00", duration: "60 phút", questions: 30, students: 25, status: "upcoming" },
  { id: 2, title: "Kiểm tra cuối kỳ - Lớp B2", class: "Lớp B2", date: "20/01/2025", time: "14:00", duration: "90 phút", questions: 50, students: 18, status: "upcoming" },
  { id: 3, title: "Kiểm tra định kỳ - Lớp A1", class: "Lớp A1", date: "10/01/2025", time: "09:00", duration: "45 phút", questions: 20, students: 25, status: "completed" },
];
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className={`px-2 py-0.5 text-xs font-medium rounded-full ${statusConfig[exam.status].color}`}>{statusConfig[exam.status].label}</span>
                  </div>
