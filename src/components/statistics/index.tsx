...
const stats = [
  { label: "Tổng học sinh", value: "2,350", change: "+12%", icon: Users, color: "bg-blue-500" },
  { label: "Khóa học hoàn thành", value: "1,245", change: "+8%", icon: BookOpen, color: "bg-green-500" },
  { label: "Bài kiểm tra", value: "856", change: "+15%", icon: Award, color: "bg-purple-500" },
  { label: "Điểm trung bình", value: "8.2", change: "+0.3", icon: TrendingUp, color: "bg-amber-500" },
];
